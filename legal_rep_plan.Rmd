...
```{r fig1, engine = "tikz", engine.opts = list(template = "legal_rep_plan.tex"), fig.cap = "Washington Standards-Based Legal Representation Logic Model", results=TRUE, echo=FALSE, out.extra='', cache=TRUE}
...
```{r fig2, engine = "tikz", engine.opts = list(template = "legal_rep_plan.tex"), fig.cap = "Condensed Logic Model", results=TRUE, out.extra='', echo=FALSE, cache=TRUE}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=4cm,very thick,
square/.style={regular polygon,regular polygon sides=4,fill=blue,draw=none,text=white}]
...
```{r fig3, engine = "tikz", engine.opts = list(template = "legal_rep_plan.tex"), fig.cap = "Highlighted Effects", results=TRUE, echo=FALSE, out.extra='', cache=TRUE}
...
```{r fig4, engine = "tikz",  engine.opts = list(template = "legal_rep_plan.tex"), results=TRUE, echo=FALSE, fig.cap = "Data Linkage Plan"}
